...
class Hopital_Page extends StatefulWidget {
  const Hopital_Page({super.key});

  @override
  State<Hopital_Page> createState() => _Hopital_PageState();
}

class _Hopital_PageState extends State<Hopital_Page> {
  List<dynamic> post = [];
