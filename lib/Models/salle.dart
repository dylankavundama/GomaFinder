...
class Salle_Page extends StatefulWidget {
  const Salle_Page({super.key});

  @override
  State<Salle_Page> createState() => _Salle_PageState();
}

class _Salle_PageState extends State<Salle_Page> {
  List<dynamic> post = [];
  ...
  fetchPosts() async {
    ...
    var url = 'http://$Adress_IP/goma/salle.php';
